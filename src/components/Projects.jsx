...
const Projects = () => {
    return (
        <section id="projects" className="py-20 bg-pink-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-4xl font-bold text-center mb-16 text-purple-900">Our Success Stories</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12 items-center justify-items-center max-w-6xl mx-auto">
                <div className="bg-white/90 backdrop-blur-sm shadow-lg rounded-lg overflow-hidden hover:shadow-xl transition-all duration-300 w-full max-w-sm">
                    ...
                    <div className="p-6">
                        <h3 className="text-xl font-semibold mb-2 text-purple-800">Retirement Planning</h3>
                ...
                <div className="bg-white/90 backdrop-blur-sm shadow-lg rounded-lg overflow-hidden hover:shadow-xl transition-all duration-300">
                    ...
                    <div className="p-6">
                        <h3 className="text-xl font-semibold mb-2 text-purple-800">Real Estate Investment</h3>
                ...
                <div className="bg-white/90 backdrop-blur-sm shadow-lg rounded-lg overflow-hidden hover:shadow-xl transition-all duration-300">
                    ...
                    <div className="p-6">
                        <h3 className="text-xl font-semibold mb-2 text-purple-800">Education Fund</h3>
